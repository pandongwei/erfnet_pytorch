...
img = cv2.imread('/mrtstorage/users/pan/freiburg_forest_multispectral_annotated/freiburg_forest_annotated/test/depth_gray/b1-09517_Clipped_redict_depth_gray.png',cv2.IMREAD_GRAYSCALE)
img = (img/255.).astype(np.float32)
dataFile1 = "/home/pan/Downloads/Grass/Train/003_001_MLB_0638_100x100_1.mat"
data1 = scio.loadmat(dataFile1)
depth_img = (data1['Depth']+6).astype(np.float32)
